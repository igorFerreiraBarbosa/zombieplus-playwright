...
export class Movies {
  ...
  async create(movie) {
    ...
    await this.page.locator('.react-select__option').getByText(movie.company).click()
    await this.page.locator(' #select_year .react-select__indicator').click()
    await this.page.locator('.react-select__option').getByText(movie.release_year).click()
  ...
  async shouldAlertHaveText(target) {
